...
- [express-async-errors](https://github.com/davidbanham/express-async-errors) - async/await error handling support for express
- [object.pickomit](https://github.com/furkanisitan/object.pickomit) - Select req.body fields for field-based authorization
...
Sample HTTP requests can be found in [this folder](./tests). 
